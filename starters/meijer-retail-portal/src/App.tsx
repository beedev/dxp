...
const customerNav: NavItem[] = [
  ...
  { label: 'Party Planner', href: '/customer/projects' },
  ...
  { label: 'mPerks Rewards', href: '/customer/loyalty' },
];
...
// Renamed from "Cooperative" — Meijer is a family-owned chain, not a co-op.
// "Corporate" persona owns multi-region performance, supply chain, and
// vendor relationships across all Meijer stores.
const coopNav: NavItem[] = [
  { label: 'Region Dashboard', href: '/coop' },
