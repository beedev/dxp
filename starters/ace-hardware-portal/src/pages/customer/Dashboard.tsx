...
const recentOrders = [
  { id: 'ORD-4812', items: 'DeWalt 20V Drill Kit, Stanley Tape Measure', total: 123.98, status: 'Ready for Pickup' as const, date: '2026-04-07' },
  { id: 'ORD-4798', items: 'Benjamin Moore Regal Select (2 gal), KILZ Primer', total: 147.96, status: 'Delivered' as const, date: '2026-04-03' },
  { id: 'ORD-4781', items: 'Moen Magnetix Showerhead, SharkBite Fitting Kit', total: 82.96, status: 'Processing' as const, date: '2026-04-01' },
];
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-[var(--dxp-text-secondary)]">ACE Rewards member since {new Date(currentMember.memberSince).getFullYear()}</p>
      </div>
      ...
      <Card className="p-6 mb-6 bg-gradient-to-r from-red-700 via-red-600 to-amber-500 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h2 className="text-2xl font-extrabold mb-1">Spring Home Refresh Sale</h2>
            <p className="text-sm opacity-90">Up to 30% off paint, outdoor furniture & garden essentials. Now through April 20.</p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          { label: 'Find My Store', icon: <MapPin size={20} className="text-[var(--dxp-brand)]" />, path: '/customer/store', desc: 'Locate your nearest ACE' },
          { label: 'Book a Service', icon: <Wrench size={20} className="text-[var(--dxp-brand)]" />, path: '/customer/services', desc: 'Key cutting, paint mixing & more' },
